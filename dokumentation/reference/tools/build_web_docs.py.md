...
Generiert aus dem dokumentation-Ordner eine statische HTML-Dokumentationsseite mit Navigation, Suche und Source-Ansichten.
...
- [tools/generate_docs.py](generate_docs.py.md)
